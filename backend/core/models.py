...
class ProductImages(models.Model):
    ...
    product = models.ForeignKey(
        Product, related_name="p_images", on_delete=models.CASCADE
    )
    createdAt = models.DateTimeField(auto_now_add=True)
...
class Review(models.Model):
    ...
    comment = models.TextField(default="No Comment", null=False, blank=False)
    createdAt = models.DateTimeField(auto_now_add=True)
...
class Order(models.Model):
    ...
    shippingAddress = models.ForeignKey(
        ShippingAddress, on_delete=models.CASCADE, default="0"
    )
