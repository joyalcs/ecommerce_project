...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='items',
            field=models.ForeignKey(default='0', on_delete=django.db.models.deletion.CASCADE, to='core.orderitem'),
        ),
        migrations.AddField(
            model_name='order',
            name='paymentId',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default='0', on_delete=django.db.models.deletion.CASCADE, to='core.shippingaddress'),
        ),
